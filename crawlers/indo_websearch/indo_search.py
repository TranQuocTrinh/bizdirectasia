...
class SW:
    ...
    def search(self, company_name, company_id):
        ...
        #self.driver.get(url)
        time.sleep(1)
        data = {"search":search,"index":str(company_id)}
...
url = 'https://id.search.yahoo.com/search?p=abc&fr=yfp-t&fp=1&toggle=1&cop=mss&ei=UTF-8'
ids = ['167.71.195.129:3128', '167.71.195.118:3128', '167.71.195.133:3128', '167.71.195.137:3128', '68.183.181.231:3128',
        '167.71.205.166:3128', '157.230.42.234:3128', '167.71.196.50:3128', '167.71.193.70:3128', '167.71.205.179:3128',
        '167.71.205.168:3128', '167.71.193.153:3128', '134.209.111.46:3128', '167.71.205.174:3128', '167.71.205.178:3128']
path = './indo_beritanegara.csv'
def read_csv(path):
    df = pd.read_csv(path)
    return list(df['index']), list(df['badan_hukum'])
