...
number_search = 1000
pathFile = "thai.csv"
pathFolder = "./data_thai"+str(stt)+"/"
pathResult = "./data_thai"+str(stt)+"/results.csv"
...
def get_ips(one=1):
    if one == 0:
        requests.get("https://places.bizdirectasia.com/proxy/renew?group=0")
        time.sleep(600)
    driver = requests.get("https://places.bizdirectasia.com/proxy/list?group=0")
