...
if '__main__' == __name__:
    ...
    client = SocketClient("henryvn2004@gmail.com", "Saigon123")
    ...
    driver.get('http://datawarehouse2.dbd.go.th/bdw/home/login.html')
    imgstring = driver.find_element_by_css_selector("img[src*=\"/bdw/home/captcha.html\"]").screenshot_as_base64
    try:
        # Put your CAPTCHA image file name or file-like object, and optional
        # solving timeout (in seconds) here:
        captcha = client.decode(imgstring, DEFAULT_TIMEOUT)
    ...
    if captcha:
        ...
        # filename = 'text.png'  # I assume you have a way of picking unique filenames
        # with open('D:/abc/captcha-' + captcha['text'] + '.png', 'wb') as f:
        #     f.write(imgdata)
