...
def create_driver(url='https://cse.google.com/cse?cx=partner-pub-6660800402070493%3A1389343728&q=ttq'):
    # set hiden chrome
    ...
    driver = webdriver.PhantomJS() # Chrome(chrome_options=chrome_options)#,options=options)
